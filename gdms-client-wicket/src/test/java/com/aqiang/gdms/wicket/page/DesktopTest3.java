...
public class DesktopTest3 extends PageTest {
	...
	@Test
	public void testDeskTopCollegeManagerAppliSubject() {
		...
		isTrue(ws.isElementPresent("//menuItem4"));
		isTrue(ws.isElementPresent("//menuItem5"));
		isTrue(ws.isElementPresent("//menuItem8"));
		isTrue(ws.isElementPresent("//menuItem9"));
		isTrue(ws.isElementPresent("//menuItem20"));
