...
public class DesktopTest extends PageTest {
	...
	@Test
	public void testDeskTopAdminLogin() {
		...
		isTrue(ws.isElementPresent("//menuItem2"));
		isTrue(ws.isElementPresent("//menuItem3"));
		isTrue(ws.isElementPresent("//me"));
		isTrue(ws.isElementPresent("//manageCollege"));
		isTrue(ws.isElementPresent("//manageParameter"));
	}
}
