...
public class EventServiceImplTest6 extends BaseTest {

	@Test
	public void testGenereteSubjectsSelectSummaryFile() {
		...
		eventService.genereteSubjectsSelectSummaryFile(college);
	}
