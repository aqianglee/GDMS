...
public class StudentServiceImplTest2 extends BaseTest {

	@Test
	public void testDeleteUnconfirmedSubject() {
		...
		studentService.deleteUnConfirmedStudents(student2, subject2);
