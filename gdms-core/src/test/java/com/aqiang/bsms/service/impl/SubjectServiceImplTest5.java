...
public class SubjectServiceImplTest5 extends BaseTest {

	@Test
	public void testConfirmeStudent() {
		...
		subjectService.confirmeStudent(subject2, student2);
		...
		isTrue(students.get(0).getSubjects().size() == 2);
		isTrue(students.get(1).getSubjects().size() == 1);
		isTrue(students.get(2).getSubjects().size() == 2);

		isTrue(subjects.get(0).getStudents().size() == 2);
		isTrue(subjects.get(1).getStudents().size() == 1);
		isTrue(subjects.get(2).getStudents().size() == 2);
	}
